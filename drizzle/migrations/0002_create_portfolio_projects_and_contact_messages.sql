...
DROP POLICY IF EXISTS "Published portfolio projects are publicly readable" ON public.projects;
...
ALTER TABLE public.projects ADD COLUMN IF NOT EXISTS bullets text[];